<template>
  <div class="ssWrapper fixWidth">
    <div class="mainBack"><div class="fixWidth">
      <div class="notice">
        <div>삼성카드 여행은 통신판매 중개자로서 상품 및 서비스의 이행은 <strong>(주)야놀자</strong>의 책임하에 운영되고 있으며, <strong>(주)야놀자</strong>의 약관을 따릅니다.</div>
      </div>
      <img src="https://wht-img.yanolja.com/channel/samsungcard.jpg">
    </div></div>
...
export default {
  ...
  mounted() {
    // if (!this.$cookies.get('hide-popup')) {
    //   this.$store.commit('openAlert', {
    //     text: '삼성카드 여행은 통신판매 중개자로서 상품 및 서비스의 이행은 <span>(주)야놀자</span>의 책임하에 운영되고 있으며, <span>(주)야놀자</span>의 약관을 따릅니다. ',
    //     arrBtn: [
    //       {
    //         text: '오늘 하루 열지 않음',
    //         event: () => {
    //           this.$cookies.set('hide-popup', true, '1d');
    //         },
    //       },
    //       { text: '확인' },
    //     ],
